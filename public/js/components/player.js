...
export function createVideoPlayer(dl, index, resultThumbnail) {
  ...
  controls.innerHTML = `
    ...
    <div class="mori-player-bottom">
      <div class="mori-player-actions">
        ...
        <button class="mori-player-btn skip-back-btn">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
            <path d="M11.99 5V1l-5 5 5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6h-2c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8z"/>
            <text x="12" y="15.5" text-anchor="middle" font-size="5.5" fill="currentColor" font-family="sans-serif" font-weight="bold">10</text>
          </svg>
        </button>
        <button class="mori-player-btn skip-fwd-btn">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
  ...
  const skipBackBtn = controls.querySelector(".skip-back-btn");
  const skipFwdBtn = controls.querySelector(".skip-fwd-btn");
